//
// $Id: sphinxrt.cpp 4299 2013-11-05 13:58:19Z klirichek $
//
...
#pragma warning(disable:4100)
    ...
    virtual Hitpos_t*	        ZGetHitlist ( FILE * fp, const char * sKeyword, bool bID, int *pHitCount, SphDocID_t tDocID) { return NULL; }
